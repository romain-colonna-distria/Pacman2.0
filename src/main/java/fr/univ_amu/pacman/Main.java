...
import fr.univ_amu.game_engine.CoreKernel;
import fr.univ_amu.game_engine.element.Element;
import fr.univ_amu.game_engine.io_engine.KeyboardController;
import fr.univ_amu.game_engine.rule.CollisionRule;
import fr.univ_amu.game_engine.rule.GameRules;
import fr.univ_amu.game_engine.rule.PacmanRule;
import fr.univ_amu.game_engine.utils.Shape2D;
import fr.univ_amu.pacman.entity.*;
